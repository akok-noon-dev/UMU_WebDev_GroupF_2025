...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // NOTE: The JavaScript logic for adding/removing the '.interacting' class 
    // has been REMOVED as it is now handled more efficiently by CSS pseudo-classes 
